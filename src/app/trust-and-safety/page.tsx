...
export default function TrustAndSafetyPage() {
  return (
    <InfoPageShell eyebrow="Trust & Safety" title="Built on Escrow, Verification, and Masking.">
      <div>
      ...
      <div>
        ...
        <p>
          ...
          (and pay the difference into escrow) before any extra work happens.
        </p>
      </div>
      <div>
        <h2>Disputes</h2>
      ...
      <div>
        ...
        <p>
          ...
          lead is grounds for delisting — this keeps escrow protection meaningful for everyone.
        </p>
      </div>
    </InfoPageShell>
  );
