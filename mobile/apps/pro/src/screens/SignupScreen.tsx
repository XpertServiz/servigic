...
export default function SignupScreen({ navigation }: Props) {
  ...
  async function handleSignup() {
    ...
    setLoading(true);
    try {
      const { userId } = await api.register({ role: "PROVIDER", name, phone, email, password, city: "Karachi" });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Become a Servigic Pro</Text>
      <Text style={styles.subtitle}>No lead fees — pay only when you win the job.</Text>
